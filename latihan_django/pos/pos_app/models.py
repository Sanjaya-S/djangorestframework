...
class TableResto(models.Model):
    ...
    capacity = models.IntegerField(max_length = 0)
    ...
    user_create = models.ForeignKey(User, related_name = 'user_create_table_resto', blank = True, null = True, on_delete = models.)
    user_update = models.ForeignKey(User, related_name = 'user_update_table_resto', blank = True, null = True, on_delete = models.)
